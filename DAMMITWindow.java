...
public class DAMMITWindow extends JFrame {
	...
	JPanel panel = new JPanel();
       ...
       inLabel0.setBounds(120, 400, 60, 30);
       JLabel inLabel1 = new JLabel("Input 2");
       inLabel1.setBounds(270, 400, 60, 30);
       JLabel inLabel2 = new JLabel("Input 3");
       inLabel2.setBounds(420, 400, 60, 30);
       JLabel inLabel3 = new JLabel("Input 4");
       inLabel3.setBounds(570, 400, 60, 30);


       final JLabel adcLabel0 = new JLabel(Double.toString(adc0/200.0) + " Volts");
       adcLabel0.setBounds(110, 350, 100, 50);
       final JLabel adcLabel1 = new JLabel(Double.toString(adc1/200.0) + " Volts");
       adcLabel1.setBounds(260, 350, 100, 50);
       final JLabel adcLabel2 = new JLabel(Double.toString(adc2/200.0) + " Volts");
       adcLabel2.setBounds(410, 350, 100, 50);
       final JLabel adcLabel3 = new JLabel(Double.toString(adc3/200.0) + " Volts");;
       adcLabel3.setBounds(560, 350, 100, 50);
	...
	adcLabelI3.setIcon(P00);
       ...
       readAdc.addActionListener(new ActionListener() {
		...
		adcLabel0.setText(Double.toString(adc0/200.0) + " Volts");
		adcLabel1.setText(Double.toString(adc1/200.0) + " Volts");
		adcLabel2.setText(Double.toString(adc2/200.0) + " Volts");
		adcLabel3.setText(Double.toString(adc3/200.0) + " Volts");
		if (adc0 > 20 && adc0 <= 75) adcLabelI0.setIcon(P05); 
		...
		if (adc1 > 20 && adc1 <= 75) adcLabelI1.setIcon(P05); 
		...
		if (adc2 > 20 && adc2 <= 75) adcLabelI2.setIcon(P05); 
		...
		if (adc3 > 20 && adc1 <= 75) adcLabelI3.setIcon(P05); 
